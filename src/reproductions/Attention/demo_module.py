...
def main_inspection(model):
    ...
    for i in range(topk):
        ...
        save_gradient(
            "myresults/{}-vanilla-{}.png".format(arch, classes[predictions[i][1]]),
            gradient,
        )
    ...
    for i in range(topk):
        ...
        save_gradient(
            "myresults/{}-deconvnet-{}.png".format(arch, classes[predictions[i][1]]),
            gradient,
        )
    ...
    for i in range(topk):
        ...
        save_gradient(
            "myresults/{}-guided-{}.png".format(arch, classes[predictions[i][1]]),
            gradient,
        )
        save_gradient(
            "myresults/{}-guided_gradcam-{}-{}.png".format(
                arch, target_layer, classes[predictions[i][1]]
            ),
            output,
        )
